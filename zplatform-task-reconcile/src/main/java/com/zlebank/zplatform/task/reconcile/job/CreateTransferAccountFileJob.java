...
@Component
public class CreateTransferAccountFileJob {

	private static final Log log = LogFactory.getLog(CreateTransferAccountFileJob.class);
	...
	public void execute() throws Exception {
		...
		List<?> memberList = txnsLogReconService.geTransferAccountMemberByDate(dateTime);
		...
		for (Map.Entry<String, String> entry : memIDMap.entrySet()) {
			...
			// 转账汇总信息
			List<?> sumTransferAccountList = txnsLogReconService.getSumTransferAccount(memberId, dateTime);
			...
			List<?> transferDetailList = txnsLogReconService.getTransferAccountByDate(memberId, dateTime);
			JSONArray detailJsonArray = JSONArray.fromObject(transferDetailList);
